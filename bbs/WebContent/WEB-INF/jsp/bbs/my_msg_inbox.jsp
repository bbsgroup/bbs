				...
				<FORM name="smsform" onSubmit="return validate(this)"
					...
					<DIV class=mainbox style="padding-bottom: 5px">
						...
						<UL class="tabs headertabs">
							<LI class=additem><A href="${pageContext.request.contextPath}/forum/user/sms_compose.jsp">发送短消息</A></LI>
							<LI class=current><A href="${pageContext.request.contextPath}/forum/user/my_msg?action=inbox">收件箱 (<SPAN
									id=sms_unread>0</SPAN>)
							</A></LI>
							<LI><A href="${pageContext.request.contextPath}/forum/user/my_msg?action=outbox">已发送</A></LI>
