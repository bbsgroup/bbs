			...
			<DIV class=content>
				<DIV class=mainbox>
					...
					<UL class="popmenu_popup headermenu_popup" id=systemgroup_menu
						...
						<LI><A
							href="${pageContext.request.contextPath}/forum/user/my_rights?gid=A">管理员</A></LI>

						<LI><A
							href="${pageContext.request.contextPath}/forum/user/my_rights?gid=S">超级版主</A></LI>

						<LI><A
							href="${pageContext.request.contextPath}/forum/user/my_rights?gid=M">版主</A></LI>

						<LI><A
							href="${pageContext.request.contextPath}/forum/user/my_rights?gid=G">游客</A></LI>
					...
					<TABLE cellSpacing=0 cellPadding=0 width="100%">
						...
						<TBODY>
							...
							<TR>
								<TH>用户组级别:</TH>
								<TD><IMG alt="Rank: 8" src="${pageContext.request.contextPath}/media/images//star_5.gif"
									align="absmiddle" border="0"><IMG alt="Rank: 8"
									src="${pageContext.request.contextPath}/media/images//star_1.gif" align="absmiddle" border="0"><IMG
									alt="Rank: 8" src="${pageContext.request.contextPath}/media/images//star_1.gif" align="absmiddle"
									border="0"><IMG alt="Rank: 8" src="${pageContext.request.contextPath}/media/images//star_1.gif"
						...
						<TBODY>
							...
							<TR>
								<TH>允许全局置顶主题:</TH>
								<TD><IMG src="${pageContext.request.contextPath}/media/images//check_error.gif"></TD>
							</TR>
							<TR>
								<TH>允许编辑帖子:</TH>
								<TD><IMG src="${pageContext.request.contextPath}/media/images//check_right.gif"></TD>
