			...
			<DIV class=content>
				<DIV class=mainbox>
					...
					<UL class="tabs headertabs">
						<LI class=current><A href="${pageContext.request.contextPath}/forum/user/my_rights">我的权限</A></LI>
						<LI class="dropmenu" style='BACKGROUND-POSITION: 95%'><A
							id=systemgroup onmouseover=showMenu(this.id) href="###">系统用户组</A>
						</LI>
					</UL>
					<UL class="popmenu_popup headermenu_popup" id=systemgroup_menu
						style="DISPLAY: none">

						<LI><A href="./my_rights?gid=A">管理员</A></LI>

						<LI><A href="./my_rights?gid=S">超级版主</A></LI>

						<LI><A href="./my_rights?gid=M">版主</A></LI>

						<LI><A href="./my_rights?gid=G">游客</A></LI>
					...
					<TABLE cellSpacing=0 cellPadding=0 width="100%">
						...
						<TBODY>
							...
							<TR>
								<TH>用户组级别:</TH>
								<TD><IMG alt="Rank: 1" src="${pageContext.request.contextPath}/media/images/star_1.gif"
