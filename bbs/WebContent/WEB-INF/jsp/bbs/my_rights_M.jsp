				...
				<DIV class=mainbox>
					...
					<TABLE cellSpacing=0 cellPadding=0 width="100%">
						...
						<TBODY>
							...
							<TR>
								<TH>用户组级别:</TH>
								<TD><IMG alt="Rank: 7" src="${pageContext.request.contextPath}/media/images/star_5.gif"
									align="absmiddle" border="0"><IMG alt="Rank: 7"
									src="${pageContext.request.contextPath}/media/images/star_1.gif" align="absmiddle" border="0"><IMG
									alt="Rank: 7" src="${pageContext.request.contextPath}/media/images/star_1.gif" align="absmiddle"
									border="0"></TD>
							</TR>
						<THEAD>
							<TR>
