...
<form method="post" action="${pageContext.request.contextPath}/topTopic?boardId=${board.id}" >
	...
	<thead>
		...
		<tr>
			<th>置顶</th>
			<td><label><input class="radio" type="radio" name="topType"
						value="0"/> 解除置顶 </label>&nbsp;
				<label><input class="radio" type="radio" name="topType" checked 
						value="1"/> <img src="${pageContext.request.contextPath}/media/images/top_3.gif" alt="本版置顶"/> 本版置顶</label>
