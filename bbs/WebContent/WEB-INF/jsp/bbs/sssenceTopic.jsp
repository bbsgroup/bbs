...
<form method="post" action="${pageContext.request.contextPath}/sssenceTopic?boardId=${board.id}" >
...
<tr>
			<th>操作</th>
			<td><label><input class="radio" type="radio" name="sssence" value="1" 
						checked/> 加入精华</label> &nbsp;
				<label><input class="radio" type="radio" name="sssence" value="0"
						/> 解除精华</label>
			</td>
		</tr>
